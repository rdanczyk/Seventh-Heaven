...
<head>
<!--Expand2Web SmallBiz Lite Version 3.9-->
...
<style>
#header h1 {font-family:<?php echo biz_option('smallbiz_font_family_header')?>; padding-bottom:13px; font-size:<?php echo biz_option('smallbiz_font_size_head')?>px;line-height:<?php echo biz_option('smallbiz_font_size_head')?>px;}
#header h2{font-size:<?php echo biz_option('smallbiz_font_size_tag')?>px;line-height:<?php echo biz_option('smallbiz_font_size_tag')?>px;font-family:<?php echo biz_option('smallbiz_font_family_tag')?>;}
#header p {font-family:<?php echo biz_option('smallbiz_font_family_headeraddress')?>;font-size:<?php echo biz_option('smallbiz_font_size_headeraddress')?>px;line-height:<?php echo biz_option('smallbiz_font_size_headeraddress')?>px;}
h2, #post-title a, .smallbiz_map h4 {color: #<?php echo biz_option('smallbiz_headertag_color')?>;}
h1, #content h1, #sidebar h1, #featured h1, #footer h1{font-size:<?php echo biz_option('smallbiz_font_size_h1')?>px;line-height:<?php echo biz_option('smallbiz_font_size_h1')?>px;}
h2, #content h2, #sidebar h2, #footer h2{font-size:<?php echo biz_option('smallbiz_font_size_h2')?>px;line-height:<?php echo biz_option('smallbiz_font_size_h2')?>px;}

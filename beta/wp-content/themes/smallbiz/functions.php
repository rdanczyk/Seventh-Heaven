...
$GLOBALS['smallbiz_cur_version'] = "3.9";
...
function smallbiz_defaults(){
  ...
  $smallbiz_defaults = array(
    ...
    "font_family_tag" => 'Arial,Sans-Serif',
...

{
    ...
    add_option('smallbiz_font_family_header', $smallbiz_defaults['font_family_header']);
     add_option('smallbiz_font_family_tag', $smallbiz_defaults['font_family_tag']);
    ...
    add_option('smallbiz_font_size_head', $smallbiz_defaults['font_size_head']);
      add_option('smallbiz_font_size_tag', $smallbiz_defaults['font_size_tag']);
    ...
    add_option('smallbiz_page_summary_1_color', $smallbiz_defaults['summary_1_color']);
    add_option('smallbiz_page_summary_2_color', $smallbiz_defaults['summary_2_color']);
    add_option('smallbiz_page_summary_3_color', $smallbiz_defaults['summary_3_color']);
...
if(isset($_FILES['mobile-bannerhome-image']) && $_FILES['mobile-bannerhome-image']['tmp_name'] != ""){
...
update_option('smallbiz_mobile-bannerhome-image', $_FILES['mobile-bannerhome-image']['name']);
    ...
    if(isset($_FILES['map']) && $_FILES['map']['tmp_name'] != ""){
        ...
        if(isset($_POST['omit_pages']) && is_array($_POST['omit_pages']) && count($_POST['omit_pages']) >0){
...
<p><strong>The header graphic is the anchor of your site. Use it to determine the other colors.</strong></p><p>The Full version of the SmallBiz Theme will come with over 31+ graphics, plus the option to upload your own custom header graphic.</p>
    ...
    <div id="header_banner_table">
            <?php                 
                ...
                if(!is_array($user_banner_storage)){
                    $user_banner_storage = array();                    e2w_migrate_legacy_headers($user_banner_storage);
                }                
...
<table width="810" border="0">
  <tr>
  <td width="165">
<label for="font_family_tag" title="font-family_tag">Header Tagline:</label>

  </td>
 <td width="290">
<select name="font_family_tag"  class="smallbiz_font_selector"  id="font_family_tag" title="font-family_tag" tabindex="1">
<?php echo_fonts_options(get_option('smallbiz_font_family_tag')); ?>
</select>
</td></tr>
...
<td width="290"><input style="width:25px" type="text" name="font_size_tag" value="<?php echo get_option("smallbiz_font_size_tag")?>" /> Suggestion: 18</td>
...
<table width="810" border="0">
  <tr>
  <td width="165">
<label for="font_family_headeraddress" title="font-family_headeraddress">Header Address:</label>
